...
export default {
  ...
  head: {
    ...
    title: "Layout Padrão-3",
    link: [
      { rel:"icon", type:"image/svg+xml", href:"" }, // Atualize este caminho para a sua logo
    ],
    meta: [
      { charset: "utf-8" },
    ...
    link: [
      {rel: "stylesheet",
      href:
      "https://cdn.materialdesignicons.com/6.5.95/css/materialdesignicons.min.css",
      },
      {
        rel: "stylesheet",
        href:
      ...
      { rel: "icon", type: "image/svg", href:   "https://grancommtest.s3.amazonaws.com/layout-default-items/logos/gransys/logoText.png"
      },
    ],
  },
